...
kubectl apply -f https://github.com/knative/serving/releases/download/knative-v1.8.0/serving-hpa.yaml

# Enable automatic TLS certificates provisioning using Encrypt HTTP01 challenges

kubectl apply -f https://github.com/knative/net-http01/releases/download/knative-v1.8.0/release.yaml
